import ADragSupplementalController from "../../../AniGraph/amvc/2d/supplementals/controllers/ADragSupplementalController";

export default class A1DragOriginController extends ADragSupplementalController{
    /**
