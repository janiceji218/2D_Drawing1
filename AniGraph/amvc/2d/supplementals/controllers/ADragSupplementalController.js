import ASupplementalController2D from "./ASupplementalController2D";
import {Vec2} from "../../../../math/Vector";

export default class ADragSupplementalController extends ASupplementalController2D{
    ...
    getPropertyValue(){
        ...
        // this.getModel().getTranslation();
    }

    setPropertyValue(value){
        // this.getModel().setTranslation(value);
