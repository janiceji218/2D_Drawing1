...
import AShape2DVertexHandlesView from "./AShape2DVertexHandlesView";

export default class AShape2DVertexEditController extends ASupplementalController2D{
    static ViewClass = AShape2DVertexHandlesView;
