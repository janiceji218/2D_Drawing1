...
export default class Matrix3x3 {
    ...
    equalTo(M, tolerance){
        ...
        for(let i=0;i<this.elements.length;i++){
            if (Math.abs(this.elements[i] - M[i]) > epsilon){
                return false;
            }
        }
        return true;
    ...
    /**
     * Given an object with the keys 'origin', 'rotation', 'scale', and 'translation', compute
    ...
    getOriginTranslation(){return new Vec2(this.m02, this.m12);}
    //</editor-fold>
    //##################\\--Origin (Translation)--//##################
